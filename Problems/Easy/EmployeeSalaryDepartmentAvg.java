...
public class EmployeeSalaryDepartmentAvg {
 ...
 double DevAvgSalary = employeeList.stream().filter(e-> "Development".equals(e.getDepartment()))
.mapToDouble(e-> e.getSalary()).average().orElse(0.0);
  System.out.println("Development department average salary: "+DevAvgSalary);
